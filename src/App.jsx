...
const RecurringMeetingScheduler = () => {
  ...
  const handleSubmitAvailability = () => {
    ...
    try {
      ...
      if (existingParticipantIndex !== null) {
        currentParticipants[existingParticipantIndex] = participant;
      } else {
      ...
      alert('Availability saved! You can update it anytime by changing your selections.');
    } catch (error) {
    ...
    return (
      <div className="min-h-screen bg-gray-900 text-white">
        <div className="max-w-3xl mx-auto px-6 py-16">
          ...
          <div className="bg-gray-800 border-2 border-gray-700 rounded-xl p-8 shadow-xl">
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-600 rounded-lg focus:border-blue-500 focus:outline-none transition-colors bg-gray-700 text-white"
                />
              </div>
              ...
              <button
                ...
                className="w-full bg-blue-600 text-white px-6 py-3.5 rounded-lg font-semibold hover:bg-blue-700 disabled:bg-gray-600 disabled:cursor-not-allowed transition-all"
              >
                Create Meeting
              </button>
            </div>
            ...
            {meetingId && meetingData && (
              <div className="mt-8 pt-8 border-t-2 border-gray-700">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h2 className="text-xl font-bold">Meeting Created!</h2>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      value={shareLink}
                      readOnly
                      className="flex-1 px-4 py-3 border-2 border-gray-600 rounded-lg bg-gray-700 text-gray-300 font-mono text-sm"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  ...
                  <button
                    ...
                    className="border-2 border-gray-600 text-gray-300 px-4 py-3 rounded-lg font-semibold hover:bg-gray-700 transition-all"
                  >
                    Create Another
                  </button>
                </div>
  ...
  if (view === 'meeting') {
    ...
    return (
      <div className="min-h-screen bg-gray-900 text-white">
        <div className="border-b-2 border-gray-800 bg-gray-900 sticky top-0 z-10">
          ...
          <div className="space-y-6">
            <div className="bg-gray-800 border-2 border-gray-700 rounded-xl p-6">
              ...
              <div className="bg-blue-900/30 border border-blue-700 rounded-lg p-4 mb-6 text-sm text-blue-200">
                <strong>Instructions:</strong> Click and drag on the grid below to select the day-week combinations when you're available (e.g., "1st Monday"). Then select your available times for each selection. You can update your availability anytime.
              </div>

              <div className="mb-6">
                <h3 className="text-lg font-bold mb-3">Step 1: Select Day & Week</h3>
                
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse">
                    <thead>
                      <tr>
                        <th className="border-2 border-gray-600 p-2 bg-gray-750 text-xs font-semibold text-gray-400">Week of Month</th>
                        {daysOfWeek.map(day => (
                          <th key={day} className="border-2 border-gray-600 p-2 bg-gray-750 text-xs font-semibold text-gray-300">
                            {day.substring(0, 3)}
                          </th>
                        ))}
                      </tr>
                    ...
                    <tbody>
                      {weeksOfMonth.map(week => (
                        <tr key={week}>
                          <td className="border-2 border-gray-600 p-2 bg-gray-750 text-xs font-semibold text-gray-300">
                            {week}
                          </td>
                          {daysOfWeek.map(day => {
                            const key = `${week}-${day}`;
                            ...
                            return (
                              <td key={key} className="border-2 border-gray-600 p-0">
                                <button
              ...
              {Object.keys(selectedSlots).length > 0 && (
                <div className="mb-6">
                  <h3 className="text-lg font-bold mb-3">Step 2: Select Times</h3>
                  <p className="text-sm text-gray-400 mb-4">Times shown in {timezone}</p>

                  {Object.keys(selectedSlots).map(slotKey => {
                    const [week, day] = slotKey.split('-');
                    return (
                      <div key={slotKey} className="mb-4 p-4 bg-gray-750 rounded-lg border-2 border-gray-600">
              ...
              >
                {existingParticipantIndex !== null ? 'Update Availability' : 'Submit Availability'}
              </button>
            </div>
          </div>
            ...
            <div className="bg-gray-800 border-2 border-gray-700 rounded-xl p-6">
              ...
              <div className="overflow-x-auto mb-6">
                <table className="w-full border-collapse">
                  <thead>
                    <tr>
                      <th className="border-2 border-gray-600 p-2 bg-gray-750 text-xs font-semibold text-gray-400">Week</th>
                      {daysOfWeek.map(day => (
                        <th key={day} className="border-2 border-gray-600 p-2 bg-gray-750 text-xs font-semibold text-gray-300">
                          {day.substring(0, 3)}
                        </th>
              ...
              <div className="flex items-center gap-4 text-xs mb-6">
                ...
                <div className="flex items-center gap-2">
                  <div className="w-5 h-5 rounded border border-gray-600" style={{ backgroundColor: 'rgba(34, 197, 94, 0.3)' }}></div>
                  <span className="text-gray-400">Low</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-5 h-5 rounded border border-gray-600" style={{ backgroundColor: 'rgba(34, 197, 94, 0.65)' }}></div>
                  <span className="text-gray-400">Med</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-5 h-5 rounded border border-gray-600" style={{ backgroundColor: 'rgba(34, 197, 94, 1)' }}></div>
              ...
              {Object.keys(summary).length > 0 && (
                <div>
                  <h3 className="text-xl font-bold mb-4">Time Details</h3>
                  ...
                  {Object.entries(summary)
                    ...
                    .map(([slotKey, data]) => {
                      const [week, day] = slotKey.split('-');
                      return (
                        <div key={slotKey} className="mb-4 p-4 bg-gray-750 rounded-lg border border-gray-600">
                            ...
                            {Object.entries(data.times)
                              ...
                              .map(([time, names]) => (
                                <div key={time} className="flex items-start gap-3">
                                  <div className="w-20 font-semibold text-gray-300 flex-shrink-0">
                                    {time}
                                  </div>
                  ...
                  {Object.keys(summary).length > 5 && (
                    <p className="text-sm text-gray-500 text-center">
                      Showing top 5 most available slots
                    </p>
                  )}
                </div>
              )}
              ...
              <div className="bg-gray-800 border-2 border-gray-700 rounded-xl p-6">
                ...
                <div className="space-y-2">
                  {participants.map((participant, idx) => (
                    <div key={idx} className="p-3 bg-gray-750 rounded-lg border border-gray-600">
                      <div className="font-semibold text-gray-200 text-sm">
                        {participant.name}
                      </div>
                      <div className="text-xs text-gray-400">
                        {participant.email} • {Object.keys(participant.availability).length} slot{Object.keys(participant.availability).length !== 1 ? 's' : ''}
                      </div>
                    </div>
                  ))}
                </div>
        ...
        <style>{`
          ...
          * { font-family: 'Inter', sans-serif; }
          ...
          .bg-gray-750 { background-color: rgb(49, 55, 66); }
        `}</style>
      </div>
    );
  }
